...
def test():
    ...
    data = b''
    # data = b'01 03 90 00 03 00 03 00 00 01 F4 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 D0 D2'
    data = str(binascii.b2a_hex(data))[2:-1]  # Hex转换成字符串

    print("_____________________  1~64路  ______________________________")
    global index
    index = 0
    weight_64 = decodeData(data)
    print("_____________________  64~128路  ______________________________")
    # data = b"01 03 90 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 BB 13"
    weight_128 = decodeData(data)
...
def testSerial():
    ...
    data = bytes.fromhex("01 03 00 00 00 48 45 FC")
    device.write(data)
    size = device.inWaiting()
    print("--------->", size)
    # result = device.readline()
    # result = device.read(149)
    result = ""
    result = str(binascii.b2a_hex(device.read(149)))[2:-1]  # Hex转换成字符串
    print(len(result))
    print(result)
    data = str(result)
    print(data)
